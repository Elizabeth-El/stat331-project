...
ggplot(combined_data, aes(x = log10(`GDP per Capita`), y =`Life Expectancy`)) +
  ...
  labs( title = "Plot 1: GDP and Life Expectancy Regression Faceted by Continent", subtitle = "GDP is in international dollars and fixed at 2017 prices", x = "Log of GDP per Capita", y = "Life Expectancy", color = "Continent") + 
  theme_bw() +
...
## Regression Model
***introduce plot and regression model: worth 7 points!***
...
ggplot(aes(x = r2s)) +
  ...
  labs(x = "R squared values", y = "Density", title = "Sample Distribution of R Square Values", subtitle = "For predicted vs actual log of GDP per Capita")
```
***discuss results***
