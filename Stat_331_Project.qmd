...
Our findings concur with existing research and support the general conclusion that an increase in per person wealth increases lifespan. An important thing to note is that our model used a log transformation on GDP meaning that smaller economies will derive more benefit from the same increase in GDP per capita than larger economies.
